...
class RentalIncomePredictor:
    ...
    def save_model(self, model_dir='trained_models/Rental_Income'):
    ...
    def load_model(self, model_dir='trained_models/Rental_Income'):
    ...
    def predict_rental_income(self, property_data):
...
def main():
    """Main function to train the rental income prediction model"""
    ...
    if len(X) == 0:
        print("Error: No valid rental data found")
        return
